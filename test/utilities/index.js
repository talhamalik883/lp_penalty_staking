...
module.exports.BASE_TEN = 10
module.exports.ADDRESS_ZERO = "0x0000000000000000000000000000000000000000"

module.exports.encodeParameters = function(types, values) {
  const abi = new ethers.utils.AbiCoder()
  return abi.encode(types, values)
}

module.exports.prepare = async function(thisObject, contracts) {
...
module.exports.deploy = async function(thisObject, contracts) {
  for (let i in contracts) {
    let contract = contracts[i]
...
module.exports.createSLP = async function(thisObject, name, tokenA, tokenB, amount) {
...
module.exports.getBigNumber = function(amount, decimals = 18) {
